---
name: WORLD_SIM_FRONTEND-design
description: Design system skill for WORLD_SIM_FRONTEND. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX.
---

# WORLD_SIM_FRONTEND Design System

You are building UI for **WORLD_SIM_FRONTEND**. Light-themed, neutral palette, sans-serif typography (sans-serif), compact density on a 4px grid, flat elevation (no shadows).
...
- Creating new components, pages, or visual elements for WORLD_SIM_FRONTEND
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "WORLD_SIM_FRONTEND" design, style, UI, or theme
