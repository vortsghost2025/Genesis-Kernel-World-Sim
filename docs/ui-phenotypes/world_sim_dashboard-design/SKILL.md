---
name: WORLD_SIM_DASHBOARD-design
description: Design system skill for WORLD_SIM_DASHBOARD. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX.
---

# WORLD_SIM_DASHBOARD Design System

You are building UI for **WORLD_SIM_DASHBOARD**. Light-themed, neutral palette, sans-serif typography (sans-serif), compact density on a 4px grid, flat elevation (no shadows).
...
- **Site URL:** `file:///workspace/4a3ce27d-ed21-4f70-a11a-d7408091f4c3/sessions/agent_58263213-06cd-4452-8714-461bf61bc536/world-sim/frontend/sim.html`
...
- Creating new components, pages, or visual elements for WORLD_SIM_DASHBOARD
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "WORLD_SIM_DASHBOARD" design, style, UI, or theme
